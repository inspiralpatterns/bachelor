...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 75.0, 30.0, 135.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 39.0, -1.0, 92.0, 20.0 ],
					"text" : "Window option",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 415.0, 452.477966, 124.0, 22.0 ],
					"restore" : 					{
						"scale" : [ 1.0 ],
						"sigma" : [ 0.5 ],
						"size" : [ 1024 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 765.0, 167.0, 98.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 3.0, 77.0, 128.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 765.0, 107.0, 94.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 3.0, 41.0, 128.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_linknames" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 675.0, 120.0, 27.0, 22.0 ],
					"text" : "t b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 141.795654, 525.0, 27.0, 22.0 ],
					"text" : "t b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 791.5, 45.0, 92.0, 22.0 ],
					"text" : "loadmess 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 832.0, 191.895584, 47.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 48.0, 91.375183, 48.0, 18.0 ],
					"text" : "window",
					"textcolor" : [ 0.901961, 0.901961, 0.901961, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 765.0, 15.0, 102.0, 22.0 ],
					"text" : "loadmess 1024"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 675.0, 45.0, 78.0, 22.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 886.5, 165.0, 42.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 132.0, 76.0, 42.0, 18.0 ],
					"text" : "Sigma ",
					"textcolor" : [ 0.901961, 0.901961, 0.901961, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 825.0, 135.0, 28.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 54.0, 57.479599, 28.0, 18.0 ],
					"text" : "Size",
					"textcolor" : [ 0.901961, 0.901961, 0.901961, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 886.5, 105.0, 57.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 133.0, 40.0, 32.0, 18.0 ],
					"text" : "Amp",
					"textcolor" : [ 0.901961, 0.901961, 0.901961, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.0, 390.0, 122.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 765.0, 192.895584, 48.0, 16.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 3.0, 92.375183, 48.0, 16.0 ],
					"text" : "open",
					"textcolor" : [ 0.901961, 0.901961, 0.901961, 1.0 ],
					"varname" : "display-open"
				}
...
,
					"patching_rect" : [ 507.5, 180.0, 81.0, 22.0 ],
...
,
					"patching_rect" : [ 415.0, 180.0, 80.970001, 54.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Georgia",
						"default_fontsize" : 14.0,
...
,
					"patching_rect" : [ 322.5, 180.0, 91.0, 22.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Georgia",
						"default_fontsize" : 14.0,
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "float", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 380.0, 247.390808, 56.0, 22.0 ],
									"varname" : "sigma"
								}
...
,
					"patching_rect" : [ 230.0, 180.0, 56.0, 22.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Georgia",
						"default_fontsize" : 14.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 972.0, 165.0, 57.0, 22.0 ],
					"text" : "s sigma"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 285.0, 322.624817, 27.0, 22.0 ],
					"text" : "t 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 285.0, 285.0, 78.0, 22.0 ],
					"text" : "pvar sigma"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 979.0, 135.0, 43.0, 22.0 ],
					"text" : "s size"
				}
...
,
					"patching_rect" : [ 137.5, 180.0, 68.0, 22.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Georgia",
						"default_fontsize" : 14.0,
...
,
					"patching_rect" : [ 45.0, 180.0, 73.0, 22.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Georgia",
						"default_fontsize" : 14.0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 765.0, 135.0, 49.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 3.0, 57.479599, 49.0, 18.0 ],
					"textcolor" : [ 0.901961, 0.901961, 0.901961, 1.0 ],
					"varname" : "size"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 120.0, 285.0, 65.0, 22.0 ],
					"text" : "pvar size"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 156.795654, 452.477966, 47.0, 22.0 ],
					"text" : "s amp"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 141.795654, 486.403809, 159.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "float" ],
					"patching_rect" : [ 141.795654, 422.477966, 34.0, 22.0 ],
					"text" : "t b f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 141.795654, 390.0, 72.0, 22.0 ],
					"text" : "pvar scale"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 141.795654, 360.0, 78.0, 22.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 45.0, 30.0, 81.0, 22.0 ],
					"text" : "loadmess 0"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 45.0, 117.895584, 574.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 45.0, 80.520401, 156.97998, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 3.0, 21.0, 156.97998, 18.0 ],
					"textcolor" : [ 0.901961, 0.901961, 0.901961, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 120.0, 322.624817, 103.0, 20.0 ],
					"text" : "sizeinsamps $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 141.795654, 630.0, 111.0, 22.0 ],
					"text" : "buffer~ window"
				}
