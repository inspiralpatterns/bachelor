...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"comment" : "signal to ambiencode",
					"id" : "obj-3",
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 86.064453, 193.0, 25.0, 25.0 ]
				}

			}
, 			{
				"box" : 				{
					"comment" : "ambimonitor source in",
					"id" : "obj-2",
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 156.427216, 51.476196, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 86.064453, 51.476196, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 160.427216, 20.476196, 123.0, 31.0 ],
					"text" : "| ambimonitor source\nV"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 86.064453, 20.476196, 65.0, 31.0 ],
					"text" : "| signal in\nV"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 225.064453, 134.328583, 71.0, 19.0 ],
					"text" : "loadmess 2."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 227.064453, 105.779358, 105.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 156.427216, 109.779358, 48.0, 19.0 ],
					"text" : "route 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 156.427216, 86.346039, 57.0, 19.0 ],
					"text" : "route aed"
				}
...
,
					"patching_rect" : [ 86.064453, 164.5, 158.0, 19.0 ],
...
,
					"patching_rect" : [ 86.064453, 134.328583, 73.0, 19.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 11.0,
