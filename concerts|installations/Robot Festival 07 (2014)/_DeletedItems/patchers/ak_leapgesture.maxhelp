...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 517.0, 286.0, 139.0, 18.0 ],
					"text" : "6.04201"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 368.0, 286.0, 115.0, 18.0 ],
					"text" : "9.301714"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 303.0, 18.0, 180.0, 51.0 ],
					"text" : "o.io.leap"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 185.5, 243.0, 474.0, 20.0 ],
					"text" : "o.route /gesture/swipe/direction/x /gesture/swipe/direction/y /gesture/circle/angle/sweep"
				}
