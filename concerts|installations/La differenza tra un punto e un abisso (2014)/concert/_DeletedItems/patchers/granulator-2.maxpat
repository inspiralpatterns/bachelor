...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 690.0, 846.0, 32.5, 22.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 703.5, 780.0, 86.0, 22.0 ],
					"text" : "r gran-rev-2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 242.5, 765.0, 122.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 343.214111, -6.0, 196.785889, 74.0 ],
					"text" : "Granulator II",
					"textcolor" : [ 0.901961, 0.901961, 0.901961, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 690.0, 900.0, 109.0, 22.0 ],
					"text" : "send~ reverb-in"
				}
...
,
					"patching_rect" : [ 345.75, 824.0, 103.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 155.75, 975.5, 134.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 155.75, 1002.0, 32.5, 22.0 ],
					"text" : "+ 1"
				}
...
,
					"patching_rect" : [ 155.75, 949.0, 209.0, 22.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 345.75, 876.0, 115.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 120.0, 1051.0, 107.0, 22.0 ],
					"text" : "print @popup 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 120.0, 825.0, 104.0, 20.0 ],
					"text" : "storagewindow"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 155.75, 857.0, 59.0, 20.0 ],
					"text" : "store $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 155.75, 904.0, 285.0, 38.0 ],
					"saved_object_attributes" : 					{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 120.0, 1076.0, 148.0, 22.0 ],
					"restore" : 					{
						"Adjust" : [ 0.0 ],
						"Adjust[1]" : [ 0.0 ],
						"denisty" : [ 0.858819 ],
						"grain-delay" : [ 929.13385 ],
						"granulation" : [ 1.0 ],
						"live.numbox" : [ 0.0 ],
						"live.text" : [ 0.0 ],
						"main-scale" : [ 0.439369 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 120.0, 765.0, 123.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"pic" : "swarm.jpg",
					"presentation" : 1,
					"presentation_rect" : [ -12.0, -0.400024, 850.0, 246.060028 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 129.5, 801.0, 699.5, 801.0 ],
					"source" : [ "obj-149", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 165.25, 1033.0, 125.25, 1033.0, 125.25, 894.0, 165.25, 894.0 ],
					"source" : [ "obj-173", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 252.0, 801.0, 699.5, 801.0 ],
					"source" : [ "obj-91", 0 ]
				}
